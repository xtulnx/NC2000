	...
	if(cmds[0]=="get"){
			...
			if(nc1020mode){
				...
				if(nc1020tw_mode){
					...
					uint8_t buf[]={0xA9,0x00,0x8D,0x14,0x12,0x00,0x02,0x93,0xA9,0x00,0x8D,0xF6,0x03,0xA9,0x00,0x8D,
				0x0D,0x12,0xA9,0x32,0x8D,0x0E,0x12,0xA9,0x01,0x8D,0x0F,0x12,0xA9,0x00,0x8D,0x10,
				0x12,0x00,0x04,0x93,0xAD,0x0F,0x12,0xF0,0x0E,0xA9,0x01,0x8D,0xFF,0x3F,0xAD,0x00,
				0x32,0x8D,0xFF,0x3F,0xB8,0x50,0xD1,0xA9,0x00,0x8D,0xFF,0x3F,0x00,0x07,0x93,0x00,
				0x04,0x83,0x4C,0x3F,0x30,};
					copy_to_addr(0x3000,buf,sizeof(buf));
				}
			}
			cpu->PC=0x3000;
