...
0x07,0x93,0x00,0x04,0x83,0x4C,0x32,0x30,};
			...
			if(nc2000mode){
				if(is_nc2600_rom()){
                    ...
                    0x0F,0x09,0xA9,0x00,0x8D,0x10,0x09,0x8D,0x11,0x09,0x00,0x17,0x05,0x4C,0x13,0x30,
                    0x00,0x16,0x05,0x00,0x27,0x05,0x4C,0x43,0x30,};
					copy_to_addr(0x3000,buf,sizeof(buf));
				}else{
                    ...
                    0xFF,0x3F,0x8D,0x00,0x32,0xA9,0x00,0x85,0xDD,0xA9,0x32,0x85,0xDE,0xA9,0x01,0x8D,
                    0xF7,0x08,0xA9,0x00,0x8D,0xF8,0x08,0x8D,0xF9,0x08,0x00,0x18,0x05,0x4C,0x13,0x30,
                    0x00,0x17,0x05,0x00,0x28,0x05,0x4C,0x43,0x30,};
					copy_to_addr(0x3000,buf,sizeof(buf));
				}
